            ...
            <div class="item-cate">
                <a href="{{route('category.detail',[isset($categories[$i*2])?$categories[$i*2]->id:''])}}">
                    <div class="cate1 cate">
                        <div class="cate-image" style="background-image: url('/upload/Category/{{isset($categories[$i*2])?$categories[$i*2]->image:''}}')"></div>
                ...
                <a href="{{route('category.detail',[isset($categories[$i*2+1])?$categories[$i*2+1]->id:''])}}">
                    <div class="cate2 cate">
                        <div class="cate-image" style="background-image: url('/upload/Category/{{isset($categories[$i*2+1])?$categories[$i*2+1]->image:''}}')"></div>
