  ...
  <div class="logo"><a href="{{route('dashboard')}}" class="simple-text logo-normal">
      ...
      <div class="sidebar-wrapper">
        <ul class="nav">
          ...
          <li class="nav-item ">
            <a class="nav-link" href="{{route('category_type.index')}}">
              <i class="material-icons">category</i>
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top " id="navigation-example">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:void(0)">Eustass-store</a>
          </div>
          ...
          <div class="collapse navbar-collapse justify-content-end">
            ...
            <ul class="navbar-nav">
              ...
              <li class="nav-item dropdown">
                ...
                <i class="fa fa-star" aria-hidden="true" style="color:red"></i> Xin chào : {{ Auth::user()->email}} <span class="caret"></span>
                </a>
