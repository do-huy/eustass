    ...
    <div class="row">
      <div class="col-md-8">
        <div class="card">
          ...
          <div class="card-body">
          <form action="{{route('category_main.update',[$category_mains->id])}}" method="post" enctype="multipart/form-data">
            @method('PUT')
            @csrf
              <div class="row">
                <div class="col-md-12">
              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <input type="text" name="name" value="{{$category_mains->name}}" class="form-control" required=""   oninvalid="this.setCustomValidity('Xin vui lòng nhập tên thể loại')" oninput="setCustomValidity('')">
                  </div>
                </div>
              </div>
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <img style="height:70px ; width:70px" src="/upload/CategoryMain/{{$category_mains->image}}" />
                    </div>
                  </div>
                </div>
              </div>
