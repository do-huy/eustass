      ...
      <div class="col-md-8">
        <div class="card">
          <div class="card-header card-header-primary">
            <h4 class="card-title">Thêm thể loại chính</h4>
            <p class="card-category">Add category</p>
          </div>
          <div class="card-body">
          <form action="{{route('category_main.store')}}" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    <label class="bmd-label-floating">Thể loại chính (Category main)</label>
              ...
              <button type="submit" class="btn btn-primary pull-right">Thêm thể loại chính</button>
